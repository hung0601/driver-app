...
import { AiOutlineDoubleLeft, AiOutlineDoubleRight, AiOutlineEye, AiOutlineLeft, AiOutlineRight } from "react-icons/ai";
...
function DriverRequests() {
    ...
    const handlePageRedirect = (page) => {
        ...
        if (page >= 1 && page <= totalPage) {
            let lastRecord = 0
            let firstRecord = page * per_page - (per_page - 1)
                    ...
                    <tbody>
                        {drivers.map((item, index) =>
                            <tr className="" key={item.id}>
                                ...
                                <td className="border border-dark border-top-0 border-bottom-0 table-cell">
                                    <div className="pt-1" style={{ width: '98%' }}>{item.id} </div>
                                </td>
                                <td className="border border-dark border-top-0 border-bottom-0 table-cell">
